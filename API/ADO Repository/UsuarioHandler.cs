...
namespace API.ADO_Repository
{
    public static class UsuarioHandler
    {
        ...
        public static bool Login(string usuario, string contraseña) //Inicio de sesión
        {
            bool resultado = false;
            using (SqlConnection sqlConnection = new SqlConnection(ConnectionString))
            {
                using (SqlCommand sqlCommand = new SqlCommand("SELECT * FROM Usuario WHERE NombreUsuario = @nombre AND Contraseña = @contraseña", sqlConnection))
                {
                    SqlParameter nombreParameter = new SqlParameter("@nombre", System.Data.SqlDbType.VarChar);
                    nombreParameter.Value = usuario;
